...
@NamedQueries({
		...
		@NamedQuery(name = "Negocio.usuario.Usuario.findByidGuia", query = "select obj from Usuario obj where :idGuia = obj.idGuia "),
		@NamedQuery(name = "Negocio.usuario.Usuario.findByactividad", query = "select obj from Usuario obj where :actividad MEMBER OF obj.actividad "),
		@NamedQuery(name = "Negocio.usuario.Usuario.findByguia", query = "select obj from Usuario obj where :guia = obj.guia ") })
public class Usuario implements Serializable, rt.jar.java.io.Serializable {
	/** 
	* <!-- begin-UML-doc -->
	* <!-- end-UML-doc -->
	* @generated "UML a JPA (com.ibm.xtools.transform.uml2.ejb3.java.jpa.internal.UML2JPATransform)"
