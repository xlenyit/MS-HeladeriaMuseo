...
public class VistaBuscarComp extends JFrame implements IGUI {
		...
		aceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Controlador.getInstance().accion(Evento.BUSCAR_COMPAÑIA, idT);
				} catch (Exception ex) {
	...
	public void actualizar(int evento, Object datos) {
		if (evento == Evento.RES_BUSCAR_COMPAÑIA_OK) {
			JOptionPane.showMessageDialog(this, datos.toString());
		} else if (evento == Evento.RES_BUSCAR_COMPAÑIA_KO)
			JOptionPane.showMessageDialog(this, "No se ha podido encontrar la compañia");
	}
}