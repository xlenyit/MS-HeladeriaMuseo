...
public class VistaMostrarPorCompañia extends JFrame implements IGUI {

	private static final long serialVersionUID = 1L;

	public VistaMostrarPorCompañia() {
		setTitle("MOSTRAR ACTIVIDADES POR COMPAÑIA");
		...
		aceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Controlador.getInstance().accion(Evento.MOSTRAR_POR_COMPAÑIA, idT);
				} catch (Exception ex) {
	...
	public void actualizar(int evento, Object datos) {
		if (evento == Evento.RES_MOSTRAR_POR_COMPAÑIA_OK) {
		...
		} else if (evento == Evento.RES_MOSTRAR_POR_COMPAÑIA_KO)
