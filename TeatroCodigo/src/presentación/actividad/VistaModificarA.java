...
public class VistaModificarA extends JFrame implements IGUI {

	private static final long serialVersionUID = 1L;

	public VistaModificarA() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (cultural.isSelected()) {
						...
						tac = new TActCultural(id, titulo, entradasDisponibles, fechaInicio, fechaFin, hora, duracion,
								precio, true);
						...
						tac = new TRepresentacion(id, entradasDisponibles, precio, fechaInicio, fechaFin, hora,
								duracion, obra, compania, temporada, true);
					}
					Controlador.getInstance().accion(Evento.MODIFICAR_ACTIVIDAD, tac);
				} catch (Exception ex) {
	...
	public void actualizar(int evento, Object datos) {
		if (evento == Evento.RES_MODIFICAR_ACTIVIDAD_OK)
			JOptionPane.showMessageDialog(this,
					"Se ha modificado correctamente la actividad con id " + (Integer) datos);
		else if (evento == Evento.RES_MODIFICAR_ACTIVIDAD_KO)
			JOptionPane.showMessageDialog(this, "No se ha podido modificar la actividad");
	}
}