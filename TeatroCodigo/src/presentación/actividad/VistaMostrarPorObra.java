...
public class VistaMostrarPorObra extends JFrame implements IGUI {

	private static final long serialVersionUID = 1L;

	public VistaMostrarPorObra() {
		setTitle("MOSTRAR ACTIVIDADES POR OBRA");
		...
		aceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Controlador.getInstance().accion(Evento.MOSTRAR_POR_OBRA, idT);
				} catch (Exception ex) {
	...
	public void actualizar(int evento, Object datos) {
		if (evento == Evento.RES_MOSTRAR_POR_OBRA_OK) {
		...
		} else if (evento == Evento.RES_MOSTRAR_POR_OBRA_KO)
