...
public class VistaEliminarEmpleado extends JFrame implements IGUI {
		...
		aceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Controlador.getInstance().accion(Evento.ELIMINAR_EMPLEADO, idT);
				} catch (Exception ex) {
	...
	public void actualizar(int evento, Object datos) {
		if (evento == Evento.RES_ELIMINAR_EMPLEADO_OK)
			JOptionPane.showMessageDialog(this, "Se ha borrado correctamente el empleado con id " + (Integer) datos);
		else if (evento == Evento.RES_ELIMINAR_EMPLEADO_KO)
