...
public class VistaModificarMeses extends JFrame implements IGUI {

	private static final long serialVersionUID = 1L;

	public VistaModificarMeses() {
		...
		aceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Controlador.getInstance().accion(Evento.MODIFICAR_NUMERO_MESES, tomc);
				} catch (Exception ex) {
	...
	public void actualizar(int evento, Object datos) {
		if (evento == Evento.RES_MODIFICAR_NUMERO_MESES_OK)
			JOptionPane.showMessageDialog(this, "El número de meses ha sido actualizado con éxito");
		else if (evento == Evento.RES_MODIFICAR_NUMERO_MESES_KO)
			JOptionPane.showMessageDialog(this, "No se ha podido realizar la actualización");
	}
}