...
public class VistaBuscarMComp extends JFrame implements IGUI {
	...
	*/
	public void vistaBuscarMiembroDeCompañia() {
		// begin-user-code
	...
	public VistaBuscarMComp() {
		setTitle("BUSCAR MIEMBRO DE COMPAÑIA");
		...
		aceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Controlador.getInstance().accion(Evento.BUSCAR_MIEMBRO_COMPAÑIA, idM);
				} catch (Exception ex) {
	...
	public void actualizar(int evento, Object datos) {
		if (evento == Evento.RES_BUSCAR_MIEMBRO_COMPAÑIA_OK) {
			JOptionPane.showMessageDialog(this, datos.toString());
		} else if (evento == Evento.RES_BUSCAR_MIEMBRO_COMPAÑIA_KO)
