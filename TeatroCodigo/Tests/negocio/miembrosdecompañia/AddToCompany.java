...
public class AddToCompany {
	...
	public AddToCompany(TMiembrosDeCompañia tMiembro_correcto)
	{
	...
	public void Add_correct_no_repetido() {
		...
		int res=saMiembrosDeCompañia.addToCompany(tLineaMiembro_correcto);
	...
	public void Add_correct_repetido() {
		...
		int res=saMiembrosDeCompañia.addToCompany(tLineaMiembro_repetido);
	...
	@Test
	public void Add_idcompañia_incorrect() {
	...
	public void Add_meses_incorrect() {
		...
		int aux=saMiembrosDeCompañia.addToCompany(tLineaMiembro_correcto);
		int res=saMiembrosDeCompañia.addToCompany(tLineaMiembro_numeses_incorrecto);
		try
		{
			assertTrue(res == -1);
		}
