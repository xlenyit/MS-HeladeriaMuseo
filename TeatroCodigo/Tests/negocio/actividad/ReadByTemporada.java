...
public class ReadByTemporada {
	...
	private static TObra tObra = new TObra(-1, "Comedia", "Va un tio y se cae", "T_READ_BY_TEMP", "Mike Wazowski", 2021, true);
	private static TCompañia tComp = new TCompañia(-1, "T_READ_BY_TEMP", "Comedia", true);
	...
	public void buscarRepresentacionCorrecto(){
		Collection<TRepresentacion> res = saActividad.readByTemporada(tTemporada.getId());
	...
	public void buscarRepresentacionIncorrecto(){	
		Collection<TRepresentacion> res = saActividad.readByTemporada(-3);
