...
public class BuscarPorEmpleado {
	...
	@Test
	public void buscarFacturaPorEmpleadoCorrecto(){
		Collection<TFacturaConProducto> res = saFactura.buscarPorEmpleado(idEmpleado);
	...
	@Test
	public void buscarFacturaPorEmpleadoIncorrecto(){
		Collection<TFacturaConProducto> res = saFactura.buscarPorEmpleado(-1);
